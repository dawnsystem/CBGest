...
async function main() {
  ...
  console.log('Collections configured:');
    ...
    console.log('  ✅ uploads (+ fileSha256, isDuplicate, fiscalYearId)');
    ...
    console.log('  3. Dedup extractos en Cloud existente: node scripts/add-bank-statement-dedup-schema.cjs');
