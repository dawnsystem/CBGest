...
const EXPECTED_COLLECTIONS = {
  ...
  settings: {
    ...
    attributes: [
      ...
      { key: 'representativeNif', type: 'string' },
  ...
  tax_reports: {
    ...
    attributes: [
      ...
      { key: 'year', type: 'integer' },
      { key: 'status', type: 'string' },
      { key: 'draft', type: 'string' },
      { key: 'exportedAt', type: 'string' },
      { key: 'fileHash', type: 'string' },
      { key: 'presentationReference', type: 'string' },
      { key: 'createdAt', type: 'string' },
      { key: 'updatedAt', type: 'string' },
    ],
    indexes: ['fiscalYearId_index', 'year_index', 'status_index'],
  },
};
