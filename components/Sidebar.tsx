...
import { LayoutDashboard, FileText, BookOpen, PieChart, Settings, FileCheck } from 'lucide-react';
    ...
    <aside className="hidden md:flex w-64 bg-slate-900 text-white h-screen fixed left-0 top-0 flex-col shadow-xl z-30">
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight">GestCB</h1>
            <p className="text-xs text-slate-400">Cataluña Edition</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="bg-slate-800 rounded-lg p-4">
          <p className="text-xs text-slate-400 mb-2">Bitácora Estado</p>
          <div className="flex items-center gap-2 mb-1">
            <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
            <span className="text-xs font-mono text-emerald-400">TSK-006 MOBILE</span>
          </div>
        </div>
      </div>
    </aside>
